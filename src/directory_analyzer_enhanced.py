...
class DirectoryAnalyzer:
    def __init__(self):
        # Setup directories
        self.results_dir = Path("C:/Projects/Moyer/data/reports")
        self.results_dir.mkdir(parents=True, exist_ok=True)
        
        # Setup logging
        log_dir = Path("C:/Projects/Moyer/logs")
...
if __name__ == "__main__":
    target_dir = "C:/Users/robmo/OneDrive/Desktop/EVA Cleanup/Phase II Evidence"
